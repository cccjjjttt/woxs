<template>
	...
	<div class="box">
      		<div class="all" @click="dj(item)" v-for="(item,index) in data">
      		<div class="alll">
	...
	export default{
		...
		methods:{
			...
			dj(item){
				...
				this.$router.push({name:'Xq',params:{_id:item._id,active:this.active,active1:this.active1,dan:this.data,fhz:4,gdd:this.gdd}})
